...
const HeaderSection: React.FC = () => {
    const { chessProfile, username, avatarUrl, email } = useSelector(
    ...
    return (
        <div className="w-full mb-8">
            <div
                className="w-full rounded-2xl p-8 relative overflow-hidden bg-card border flex flex-col justify-between"
