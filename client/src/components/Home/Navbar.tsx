    ...
    return (
        <div className="w-full h-16 flex items-center justify-between px-6 md:px-10 border-b z-50 sticky top-0 backdrop-blur-md home-navbar bg-background/80">
            ...
            >
                ...
                <span className="font-bold text-xl ml-3 tracking-wide font-display home-text-primary">
                    Gambit
                </span>
            </div>
            ...
            {!auth.isLoggedIn && !auth.isLoading && (
                <div className="flex items-center justify-end gap-4 md:gap-6">
                    <button
                        className="px-4 py-1.5 md:px-5 md:py-2 rounded-md font-bold transition-opacity hover:opacity-90 home-btn-primary"
            ...
            {auth.isLoggedIn && (
                <div
                    className="flex items-center gap-3 text-sm cursor-pointer px-2 py-1 hover:bg-accent hover:rounded-md"
                    ref={dropdownRef}
            ...
            {auth.isLoggedIn && (
                ...
                >
                    <button
                        className="flex h-10 w-full items-center gap-2 border-t px-3 text-left cursor-pointer hover:bg-accent"
                        onClick={() => {
                            setIsPopOverOpen(false);
                            navigate('/profile');
                        }}
                    ...
                    <button
                        className="flex h-10 w-full items-center gap-2 px-3 text-left cursor-pointer hover:bg-accent"
