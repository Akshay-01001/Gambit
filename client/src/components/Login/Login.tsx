    ...
    const handleEmailSubmit = async (
        ...
        if (!isLogin) {
            ...
            if (!passwordRegex.test(password)) {
                setErrorMessage(
                    'Password must be 6-14 characters long, contain at least one uppercase, one lowercase, and one special character.',
                );
                return;
            }
        }
                ...
                <div className="flex flex-col mt-10 w-[80%] h-[90%] justify-between">
                    ...
                    <div className="flex flex-col gap-3 mb-12">
                        ...
                        <div className="max-w-sm text-lg footer-text mt-3">
                            Sign in to save your rating, review your games, and
