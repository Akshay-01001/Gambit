                    ...
                    <div className="max-h-56 overflow-y-auto p-1">
                        {countries.map((country) => (
                            <button
                                ...
                                className={`relative flex w-full items-center rounded-sm py-2 pl-2 pr-8 text-left text-sm transition-colors hover:bg-cyan-500 hover:text-white ${
                                    value === country.code
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <span
                                        className={`w-5 text-left text-[10px] font-bold uppercase tracking-wider ${
                                            value === country.code
                                                ? 'text-white/70'
