...
const gameModes = [
    {
        ...
        icon: (
            <svg
                ...
                className="lucide lucide-rocket h-4 w-4 text-primary"
                aria-hidden="true"
            >
        ...
        options: [
            {
                time: '1 min',
                label: 'Bullet',
                socket_data: GAME_TYPES['bullet_1'],
            },
            {
                time: '2 min',
                label: 'Bullet',
                socket_data: GAME_TYPES['bullet_2'],
            },
        ],
    },
    {
        ...
        options: [
            {
                time: '3 min',
                label: 'Blitz',
                socket_data: GAME_TYPES['blitz_3'],
            },
            {
                time: '5 min',
                label: 'Blitz',
                socket_data: GAME_TYPES['blitz_5'],
            },
        ],
    },
    {
        ...
        icon: (
            <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-timer h-4 w-4 text-primary"
                aria-hidden="true"
            >
        ...
        options: [
            {
                time: '10 min',
                label: 'Rapid',
                socket_data: GAME_TYPES['rapid_10'],
            },
            {
                time: '15 min',
                label: 'Rapid',
                socket_data: GAME_TYPES['rapid_15'],
            },
        ],
    },
];
...
const PlayPage = () => {
    const { status, id: gameId } = useSelector(
                    ...
                    <>
                        <div className="mb-10 flex flex-col gap-3">
                            ...
                            <div className="max-w-xl text-muted-foreground">
                                Every mode is a local two-player game on one
                                device — pass the board after each move.
                            </div>
                        </div>
                                        ...
                                        {mode.options.map((option, oIdx) => (
                                            ...
                                            >
                                                ...
                                                <svg
                                                    ...
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    className="lucide lucide-arrow-right h-4 w-4 text-muted-foreground transition group-hover:translate-x-1 group-hover:text-primary"
                                                    aria-hidden="true"
                                                >
